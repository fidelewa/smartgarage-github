    ...
    <div class="content-placeholder">
      <div class="row">
        <div class="col-md-9 pr-50">
          <div id="contact_message" class="alert alert-success not_found_news"><i class="fa fa fa-envelope-o"></i>&nbsp;&nbsp;Si vous voulez acheter des pièces svp <a href="<?php echo WEB_URL;?>/contact-us" class="buy_request">contactez-nous</a>avec nom et n ° de pièce.</div>
          <div>
            <div class="row">
