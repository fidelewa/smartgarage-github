...
.totals-row .wide-cell { border:1px solid #fff; border-right:1px solid #555555; border-top:1px solid #555555}
  ...
  <div class="invoice-wrap">
    <div class="invoice-inner">
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
          <tr>
            ...
            <td valign="top" align="right"><p class="editable-text" id="extra">Facture d'achat</p></td>
          </tr>
        </tbody>
      </table>
	  ...
	  <br/>
	  <div id="items-list">
        <div style="font-weight:bold;font-size:12px;border-bottom:solid 1px #000;margin-bottom:10px;">Informations d'achat</div>
		<table class="table">
			<tr>
				<td><div style="border-bottom:solid 1px #000;width:200px;"><b>Nom du fournisseur :</b>&emsp;<?php echo $row['supplier_name']; ?></div></td>
      ...
      <div class="notes-block">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tbody>
            <tr>
              <td align="left"><div class="editable-area" id="notes" style="font-style:italic;border-top:solid 1px #000;width:150px;text-align:center;">Signature du fournisseur</div></td>
			  <td align="right"><div class="editable-area" id="notes" style="font-style:italic;border-top:solid 1px #000;width:150px;text-align:center;">Signature de l'entreprise</div></td>
            </tr>
          </tbody>
        </table>
      </div>
