...
.totals-row .wide-cell { border:1px solid #fff; border-right:1px solid #555555; border-top:1px solid #555555}
  ...
  <div class="invoice-wrap">
    <div class="invoice-inner">
	  ...
	  <br/>
      <div id="items-list">
        <div style="font-weight:bold;font-size:12px;border-bottom:solid 1px #000;margin-bottom:10px;">Information Voiture</div>
		<table class="table">
			<tr>
				<td><div style="border-bottom:solid 1px #000;width:200px;"><b>Nom de la voiture</b>&emsp;<?php echo $row['car_name']; ?></div></td>
				<td><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Marque</b>&emsp;<?php echo $row['make_name']; ?></div></td>
				<td><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Modèle</b>&emsp;<?php echo $row['model_name']; ?></div></td>
			</tr>
			<tr>
				<td style="padding-top:10px;"><div style="border-bottom:solid 1px #000;width:200px;"><b>Année</b>&emsp;<?php echo $row['year_name']; ?></div></td>
      ...
      <div class="notes-block">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tbody>
            <tr>
              <td><div class="editable-area" id="notes" style="font-style:italic;border-top:solid 1px #000;width:150px;text-align:center;">Signature Client</div></td>
            </tr>
          </tbody>
        </table>
      </div>
...
<?php } else { ?>
<div>Facture erronée ou aucun enregistrement trouvé pour cette facture Non.</div>
<?php } ?>
<?php } else { ?>
