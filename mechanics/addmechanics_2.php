	  ...
	  <?php } ?> -->
			...
			<div class="box box-success">
				<div class="box-header">
					<h3 class="box-title col-md-12">Ajouter un nouveau mecanicien</h3>
				</div>
            ...
            <input disabled type="password" name="txtSPassword" value="<?php echo $s_password; ?>" id="txtSPassword" class="form-control" onchange="passwd()"/>
						...
						<div class="form-group  col-md-6">
							<label for="txtSEmail"> Email Addresse:</label>
						...
						<?php if (!isset($num_cni) || $num_cni == '') { ?>
							<div class="form-group  col-md-6">
								<label for="txtNCard"><span style="color:red;">*</span> CNI (Carte Nationale Identité):</label>
						...
						<div class="form-group col-md-6">
							<label for="present_address"><span style="color:red;">*</span> Adresse actuelle:</label>
