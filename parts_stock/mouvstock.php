...
<body>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="list_piece_stock" class="table sakotable table-bordered table-striped dt-responsive">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>Code</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#list_piece_stock tfoot th').each(function() {
                var title = $(this).text();
                $(this).html('<input type="text" placeholder="Recherche ' + title + '" />');
            });

            // DataTable
            var table = $('#list_piece_stock').DataTable();
