...
<section class="content-header">
    <h1><i class="fa fa-wrench"></i> Liste des devis de réparation de mes véhicules réceptionnés</h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo WEB_URL ?>dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Liste des devis de réparation de mes véhicules réceptionnés</li>
    </ol>
</section>
<!-- Main content -->
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                <div class="box-header">
                    ...
                    <h3 class="box-title"><i class="fa fa-list"></i> Liste des devis de réparation de mes véhicules réceptionnés</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table sakotable table-bordered table-striped dt-responsive">
                        ...
                        <tbody>
                            <?php
                            $result = $wms->getAllRepairCarDiagnosticDevisListByCustId($link, $_SESSION['objCust']['user_id']);
