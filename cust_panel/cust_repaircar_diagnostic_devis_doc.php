...
if (!empty($row) && count($row) > 0) { ?>
    ...
    <body cz-shortcut-listen="true">
        <div id="editor" class="edit-mode-wrap" style="margin-top: 20px">
            ...
            <div class="invoice-wrap">
                <div class="invoice-inner">
                    ...
                    <div id="content_2">
                        <!-- <div class="cadre col-sm-12" style="margin:0px;"> -->
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-6">
        ...
        <!-- <div id="mobile-preview-close_2">
            <a style="" href="<?php echo WEB_URL; ?>cust_panel/devis_client_validation.php?vehi_diag_id=<?php echo $_GET['vehi_diag_id']; ?>&devis_id=<?php echo $_GET['devis_id']; ?>&nom_client=<?php echo $row['c_name']; ?>">
                Valider le devis
            </a>
        </div> -->
        <script>
