...
if (!isset($_SESSION['objCompta']) || empty($_SESSION['objCompta'])) {
...
if (!empty($_SESSION['objCompta']['image'])) {
  $user_image = WEB_URL . 'img/upload/' . $_SESSION['objCompta']['image'];
}
?>
<!DOCTYPE html>
<html>
      ...
      <section class="sidebar" style="margin-top:10px;">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview <?php if ($page_name != '' && $page_name == 'reception_vehicule') {
            ...
            <a href="<?php echo WEB_URL; ?>recep_panel/recep_repaircar_reception.php"> <i class="fa fa-user"></i> <span>Réception de véhicules</span> <i class="fa fa-angle-left pull-right"></i> </a>
            <ul class="treeview-menu">
              <li class="<?php if ($page_name != '' && $page_name == 'reception_vehicule') {
                            echo 'active';
                          } ?>">
                <a href="<?php echo WEB_URL; ?>recep_panel/recep_repaircar_reception.php"><i class="fa fa-arrow-circle-right"></i>Réception de véhicules</a>
              </li>
              <li class="<?php if ($page_name != '' && $page_name == 'reception_vehicule_list') {
                            echo 'active';
                          } ?>">
                <a href="<?php echo WEB_URL; ?>recep_panel/recep_repaircar_reception_list.php"><i class="fa fa-arrow-circle-right"></i>Liste des véhicules réceptionnés</a>
              </li>
