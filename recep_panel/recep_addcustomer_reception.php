...
$form_url = WEB_URL . "repaircar/addcar_reception.php";
$id = "";
$hdnid = "0";
...
if (isset($_POST['txtCName'])) {
	...
	if ((int)$_POST['customer_id'] > 0) {
		...
		$url = WEB_URL . 'recep_panel/recep_addcar_reception.php?m=add_customer';
		header("Location: $url");
	}
	exit();
	// } else {
...
<section class="content-header">
	<h1><i class="fa fa-users"></i> Formulaire d'ajout d'un nouveau client </h1>
	<ol class="breadcrumb">
				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" name="princ_tel" value="<?php echo $c_princ_tel; ?>" id="princ_tel" class="form-control" placeholder="Saisissez votre numéro de téléphone principal" />
						</div>
						<div class="form-group">
							<label for="txtCEmail"> Email :</label>
