...
<section class="content-header">
  <h1><i class="fa fa-wrench"></i> Ma Voiture de réparation</h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo WEB_URL?>dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Voitures de réparation Liste</li>
  </ol>
</section>
<!-- Main content -->
  ...
  <div class="col-xs-12">
    ...
    <div class="box box-success">
      <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list"></i> Voitures de réparation Liste</h3>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
				  ...
				  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-xs-12">
						...
						<b>Date Ajout :</b> <?php echo date('d/m/Y h:m:s', strtotime($row['added_date'])); ?>
                      </div>
                    </div>
                  </div>				  
                </div>
