...
// $_SESSION['immat'] = $_GET['immat'];
// $_SESSION['objLogin']['immat'] = $_GET['immat'];
// var_dump($_SESSION);
        ...
        <div class="col-md-12">
              ...
              <div class="pull-right">
                ...
                <?php if (isset($_GET['id']) && $_GET['id'] != '') { ?>
                  <button type="button" onclick="javascript:window.print();" class="btn btn-danger btnsp"><i class="fa fa-print fa-2x"></i><br />
                    Print</button>&emsp;
                <?php } ?>
                <a class="btn btn-warning btnsp" data-toggle="tooltip" href="<?php echo WEB_URL; ?>reception/repaircar_reception.php" data-original-title="Back"><i class="fa fa-reply  fa-2x"></i><br />
                  Back</a> </div>
            </div>
          </div>
          <!-- </div> -->
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="add_date"><span style="color:red;">*</span> Date de l'assurance:</label>
              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>setting/car_assurance_setting.php" data-original-title="Ajouter une nouvelle assurance" target="_blank"><i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label for="add_date"><span style="color:red;">*</span> Date de la visite technique:</label>
