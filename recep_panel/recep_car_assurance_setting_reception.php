...
if (isset($_POST['form_token'])) {
  if ($_POST['form_token'] == 'assurance_vehicule') {
    ...
    if ($_POST['submit_token'] == '0') {
      ...
      $url = WEB_URL . 'recep_panel/recep_addcar_reception.php?m=add_assurance';
      header("Location: $url");
    } else {
      $addinfo = 'block';
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>recep_panel/recep_car_assurance_setting_reception.php" data-original-title="Rafraichir la page"><i class="fa fa-refresh"></i></a> <a class="btn btn-warning" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>recep_panel/recep_addcar_reception.php" data-original-title="Retour"><i class="fa fa-reply"></i></a></div>
