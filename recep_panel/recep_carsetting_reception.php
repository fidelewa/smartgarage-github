...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>recep_panel/recep_carsetting_reception.php" data-original-title="Refresh Page"><i class="fa fa-refresh"></i></a> &nbsp;<a class="btn btn-warning" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>recep_panel/recep_addcar_reception.php" data-original-title="Back"><i class="fa fa-reply"></i></a></div>
