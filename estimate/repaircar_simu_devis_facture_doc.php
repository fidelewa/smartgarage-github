            ...
            <div class="invoice-inner">
                <div class="row" id="header">
                    ...
                    <div class="col-xs-3 col-xs-offset-6">
                        <p><?php echo date_format(date_create($row['date_facture'], new \DateTimeZone('Africa/Abidjan')), 'd/m/Y à H:i:s'); ?></p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-5 cadre" style="width:220px;">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7" id="facture_simu_total_ht"><?php echo $row['total_ht_gene_piece_rechange_facture'] . ' ' . $currency; ?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-5">Total TVA</div>
                                        <div class="col-xs-7" id="facture_simu_total_tva"><?php echo $row['total_tva_facture'] . ' ' . $currency; ?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-5">
                                        ...
                                        <div class="col-xs-7">
                                            <p style="font-size:9pt;font-weight:bold" id="facture_simu_total_ttc">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7" id="facture_simu_mont_du"><?php echo $row['montant_du_piece_rechange_facture'] . ' ' . $currency; ?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-5">Montant payé</div>
                                        <div class="col-xs-7" id="facture_simu_mont_paye"><?php echo $row['montant_paye_piece_rechange_facture'] . ' ' . $currency; ?></div>
                                    </div>
                                </div>
                                <!-- </div> -->
                            </div>
