...
if (isset($_POST) && !empty($_POST)) {
    ...
    $devis_data = serialize($_POST['devis_data']);
        ...
        montant_du_piece_rechange_devis, montant_paye_piece_rechange_devis, repaircar_diagnostic_id) 
    ...
    // A partir de la liste des devis, afficher la fiche du devis sélectionné

    // Sur la fiche du devis créer un bouton "Envoyer au client" pour envoyer la fiche du devis au client en pièce jointe par email
}
                                            ...
                                            <div class="row">
                                                <table class="table dt-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($rows as $row) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $total_prix_piece_rechange; ?></td>
                                                            </tr>
                                                            ...
                                                            <input type="hidden" value="<?php echo $row['qte_piece_rechange']; ?>" name="devis_data[<?php echo $i; ?>][qte_piece_rechange_devis]" />
                                                            <input type="hidden" value="<?php echo $row['prix_piece_rechange_min']; ?>" name="devis_data[<?php echo $i; ?>][prix_piece_rechange_min_devis]" />
                                                            <input type="hidden" value="<?php echo $total_prix_piece_rechange; ?>" name="devis_data[<?php echo $i; ?>][total_prix_piece_rechange_devis]" />
                                                            <?php
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" class="text-right">Montant Total (<?php echo $currency; ?>):</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input id="montant_du_piece_rechange" name="montant_du_piece_rechange_devis" type="text" value="123455" readonly class="form-control allownumberonly etotal" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4" class="text-right">Montant Payé (<?php echo $currency; ?>):</td>
                                                            <td><input id="montant_paye_piece_rechange" name="montant_paye_piece_rechange_devis" type="text" value="123456" readonly class="form-control allownumberonly etotal" /></td>
                                                        </tr>

                                                        <!-- <tr>
                                                            <td colspan="4" class="text-right">Paid(<?php echo $currency; ?>):</td>
                                                            <td><input id="total_paid" type="text" value="<?php echo $total_paid; ?>" readonly class="form-control allownumberonly" /></td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4" class="text-right">Due(<?php echo $currency; ?>):</td>
                                                            <td><input id="total_due" type="text" value="<?php echo $total_due; ?>" readonly class="form-control allownumberonly" /></td>
                                                            <td>&nbsp;</td>
                                                        </tr> -->
                                                    </tfoot>
                                                </table>
