                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" data-toggle="tooltip" href="<?php echo WEB_URL; ?>estimate/repaircar_devis_facture_update.php?facture_id=<?php echo $row['facture_id']; ?>" data-original-title="Editer la facture"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php }
                        mysql_close($link); ?>
