...
<body cz-shortcut-listen="true">
    ...
    <div id="mobile-preview-close">
        ...
        <?php if ($_GET['login_type'] == 'reception') { ?>
            <a style="" href="<?php echo WEB_URL; ?>recep_panel/recep_dashboard.php"><img src="<?php echo WEB_URL; ?>img/back.png" style="float:left; margin:0 10px 0 0;"> Retour </a>
        <?php } ?>
        <?php if ($_GET['login_type'] == 'admin') { ?>
