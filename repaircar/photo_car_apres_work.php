...
//     $delinfo = 'block';
//     $msg = "La pièce jointe a été supprimée apec succès";
// }

if (isset($_GET['m']) && $_GET['m'] == 'up_photo_car_apres_work') {
    $addinfo = 'block';
    $msg = "Photo après travaux modifiée avec succès";
}

if (isset($_GET['m']) && $_GET['m'] == 'add_photo_car_apres_work') {
    $addinfo = 'block';
    $msg = "Photo après travaux ajoutée avec succès";
}

$row = $wms->getPhotoCarApWorkByCar($link, $_GET['car_id']);
...
<section class="content-header">
    <h1> <i class="fa fa-list"></i> Liste des photos après travaux du véhicule
        <?php
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Liste des photos après travaux</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                ...
                <form method="POST" enctype="multipart/form-data" action="photo_car_apres_work_process.php">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <legend>Ajouter les photos après trapaux du véhicule</legend>

                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_1_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_2_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_3_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_4_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_5_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_6_car_ap_work" />
                                    </span>
                                </div>

                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_7_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_8_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_9_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_10_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_11_car_ap_work" />
                                    </span>
                                </div>
                                <div class="col-md-1">
                                    <span class="btn btn-file btn btn-primary">Ajouter<input type="file" name="img_12_car_ap_work" />
                                    </span>
                                </div>
                            </div>
                            ...
                            <input type="hidden" value="<?php echo $hdnid; ?>" name="photo_car_apres_work_id" />
