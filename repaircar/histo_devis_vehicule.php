...
<section class="content-header">
    <h1> Historique des devis du véhicule</h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>repaircar/histo_devis_vehicule.php?car_id=<?php echo $_GET['car_id']; ?>" data-original-title="Re-charger la page"><i class="fa fa-refresh"></i></a> </div>
            <div class="box box-success">
                <div class="box-body">
                    <div class="box-header">
                        <h3 class="box-title">Historique des devis du véhicule</h3>
                    </div>
                    <br>
                    <div>
                        <table class="table sakotable table-bordered table-striped dt-responsive">
                            ...
                            <tbody>
                                ...
                                $result = $wms->getHistoDevisListByCarId($link, $_GET['car_id']);

                                foreach ($result as $ligne) { ?>
                                    <tr>
                                        <td><?php echo $ligne['devis_id']; ?></td>
                                        <td><?php echo date_format(date_create($ligne['devis_date']), 'd/m/Y'); ?></td>
                                        <td><?php echo $ligne['imma_vehi']; ?></td>
                                    </tr>
                                <?php }
                            ?>
                            </tbody>
