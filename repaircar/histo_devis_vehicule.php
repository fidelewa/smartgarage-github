    ...
    <div class="row">
        <div class="col-md-12">
            <div align="right" style="margin-bottom:1%;"> 
                <a class="btn btn-success" title="" data-toggle="tooltip" href="<?php echo WEB_URL; ?>repaircar/histo_devis_vehicule.php?car_id=<?php echo $_GET['car_id']; ?>" data-original-title="Re-charger la page"><i class="fa fa-refresh"></i></a> 
