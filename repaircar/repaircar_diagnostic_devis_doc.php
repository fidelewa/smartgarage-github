            ...
            <div class="invoice-wrap">
                <div class="invoice-inner content_resize">
                    ...
                    <div class="row" id="content_1">
                        ...
                        <?php if ($_SESSION['login_type'] != 'mechanics') { 
                            /* Les chefs mécaniciens et électriciens n'ont pas le droit
                             de voir les informations du client sur le devis du diagnostic*/
                            ?>
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 cadre" style="width:220px;">
                                        ...
                                        <div class="row">
                                            <!-- Ajout du nouveau champ net à payer -->
