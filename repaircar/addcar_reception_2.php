            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>setting/carsetting_reception.php" data-original-title="Ajouter un nouveau modèle"><i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-1">
                    <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>setting/car_assurance_setting_reception.php" data-original-title="Ajouter une nouvelle assurance"><i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="form-group">
