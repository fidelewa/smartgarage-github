...
if (isset($_SESSION['token']) && $_SESSION['token'] == 'add') {
    $addinfo = 'block';
    $msg = "Informations de la facture ajouté avec succès";
    unset($_SESSION['token']);
}
//	update success
if (isset($_SESSION['token']) && $_SESSION['token'] == 'up') {
    $addinfo = 'block';
    $msg = "Informations de la facture modifiées avec succès";
    unset($_SESSION['token']);
}
if (isset($_GET['bcmde_id']) && $_GET['bcmde_id'] != '' && $_GET['bcmde_id'] > 0) {
    ...
    $delinfo = 'block';
    $msg = "Informations de la facture supprimées avec succès";
}
...
$result = $wms->getFactureFromDevis($link, $_GET['devis_id']);
...
<section class="content-header">
    <h1><i class="fa fa-list"></i> Liste des factures du véhicule <?php
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Liste des factures crées pour ce véhicule</li>
    </ol>
</section>
<!-- Main content -->
<section class="content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div id="me" class="alert alert-danger alert-dismissable" style="display:<?php echo $delinfo; ?>">
                ...
                Suppression des informations de la facture réussi.
            </div>
    ...
    <script type="text/javascript">
        function deleteSupplier(bcmde_id, car_id) {
            var iAnswer = confirm("Êtes-vous sûr de vouloir supprimer ce facture ?");
            if (iAnswer) {
