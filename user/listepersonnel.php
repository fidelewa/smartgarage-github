                ...
                foreach ($results as $row) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-info" style="background-color:#9bd500;color:#ffffff;" data-toggle="tooltip" href="<?php echo WEB_URL; ?>user/workToolspersonnel.php?per_id=<?php echo $row['per_id']; ?>" data-original-title="Enregister un outil de travail pour l'employé"><i class="fa fa-plus"></i></a>
