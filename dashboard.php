...
<section class="content">
  ...
  <div class="row container-fluid">
    <div class="col-lg-6 col-md-6 col-sm-6">
      <div class="box box-success">
        <div class="box-header">
          <h3 class="box-title"><i class="fa fa-list"></i> Liste des devis de diagnostic validés par les clients</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table class="table sakotable table-bordered table-striped dt-responsive">
            <thead>
              <tr>
                ...
                <th>Date exp. assur</th>
                <th>Date exp. vis. tech.</th>
                <th>Statut validation du devis</th>
                <th>Autorisation réparation</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
              ...
              foreach ($result as $row) {
                ...
                <tr>
                  ...
                  <td><?php
                      ...
                      } else if ($row['statut_autorisation_reparation'] == 1) {
