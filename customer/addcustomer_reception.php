...
if (isset($_POST['txtCName'])) {
	...
	if ((int)$_POST['customer_id'] > 0) {
		...
		$url = WEB_URL . 'repaircar/addcar_reception.php?m=add_customer';
		header("Location: $url");
	}
	exit();
	// } else {
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="pull-right">
					...
					<?php } ?>
					<a class="btn btn-warning btnsp" data-toggle="tooltip" href="<?php echo WEB_URL; ?>repaircar/addcar_reception.php" data-original-title="Retour"><i class="fa fa-reply  fa-2x"></i><br />
						Retour</a> </div>
			</div>
		</div>
		</div>
