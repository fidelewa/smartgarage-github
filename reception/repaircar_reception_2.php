...
<body>
    ...
    <section class="content-header">
        <h1><i class="fa fa-wrench"></i> Formulaire de réception d'un véhicule</h1>
        <ol class="breadcrumb">
                ...
                <div class="tab">
                    ...
                    <div class="form-group row">
                        <div class="col-md-11">
                            ...
                            <!-- <select class='form-control' onkeyup="verifImma(this.value);" onchange="loadMarqueModeleVoiture(this.value);" name="immat" id="immat">
