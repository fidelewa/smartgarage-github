...
<section class="content-header">
  <h1><i class="fa fa-line-chart"></i> Rapport de Salaires </h1>
  <ol class="breadcrumb">
...
<div class="row">
    ...
    <form id="frmcarstock" method="post" enctype="multipart/form-data">
      <div class="box box-success" id="box_model">
        <div class="box-body">
          ...
          <div class="form-group  col-md-12" style="color:red; font-weight:bold;">** Sélectionnez Date du salaire ou mois et année ensemble ou mois ou année.</div>
          <div class="form-group col-md-4">
            <label for="ddlPayment">Salaire :</label>
  ...
  <div class="col-xs-12">
    <div class="box box-success">
      <div class="box-header">
        <h3 class="box-title">Salaire Mécanicien Liste</h3>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-xs-12"> <b>Nom :</b> <?php echo $row['m_name']; ?><br/>
                            ...
                            <b>Mois payé :</b> <span class="label label-info"><?php echo $wms->getMonthValueToMonthName($row['month_id']); ?></span><br/>
							<b>Phone :</b> <?php echo $row['m_phone_number']; ?><br/>
							<b>Année payée :</b> <span class="label label-danger"><?php echo $row['year_id']; ?></span><br/>
