...
<aside class="main-sidebar">
  ...
  <div class="user-panel admin_header_border">
      ...
      <div class="pull-left info">
        ...
        <a href="<?php echo WEB_URL; ?>cust_panel/profile.php"><i class="fa fa-circle text-success"></i> En ligne</a> </div>
    </div>
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'workstatus' || $page_name == 'addworkstatus'){echo 'active';}?>"> <a href="<?php echo WEB_URL; ?>mech_panel/workstatus.php"> <i class="fa fa-wrench"></i> <span>Travail quotidien</span></a></li>
	  <li class="treeview <?php if($page_name != '' && $page_name == 'rptmsalary'){echo 'active';}?>"> <a href="<?php echo WEB_URL; ?>mech_panel/rptmsalary.php"> <i class="fa fa-money"></i> <span>Statut de salaire</span></a></li>
	  <li class="treeview <?php if($page_name != '' && $page_name == 'pagebuilder'){echo 'active';}?>"> <a href="<?php echo WEB_URL; ?>mech_panel/pagebuilder.php"> <i class="fa fa-file-powerpoint-o"></i> <span>Page de profil</span></a></li>
      </li>
    </ul>
  </section>
  <!-- /.sidebar -->
