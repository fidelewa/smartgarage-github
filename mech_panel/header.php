    ...
    <aside class="main-sidebar">
      ...
      <div class="user-panel admin_header_border">
        ...
        <div class="pull-left info">
          ...
          <a href="<?php echo WEB_URL; ?>cust_panel/profile.php"><i class="fa fa-circle text-success"></i> En ligne</a>
        </div>
      </div>
      <section class="sidebar" style="margin-top:10px;">
        ...
        <ul class="sidebar-menu">
          ...
          <!-- <li class="treeview <?php if ($page_name != '' && $page_name == 'mech_devis_repaircar_diagnostic_list') {
                                echo 'active';
                              } ?>"> <a href="<?php echo WEB_URL; ?>mech_panel/mech_repaircar_diagnostic_devis_list.php"> <i class="fa fa-file-powerpoint-o"></i> <span>Liste des devis de réparation</span></a></li> -->
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
