...
estimate_data, duree_commande, duree_travaux, travaux_prevoir, date_creation_fiche_diag, car_id, type_diagnostic) 
...
'$_POST[date_creation_fiche_diag]','$_POST[add_car_id]','$type_diagnostic')";
