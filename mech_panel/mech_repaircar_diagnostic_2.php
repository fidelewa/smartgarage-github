...
$form_url = WEB_URL . "mech_panel/mech_repaircar_diagnostic_traitement.php";
...
<body>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Création de la fiche de diagnostic</li>
        </ol>
    </section>
    ...
    <div class="container">
        ...
        <form action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data" id="regForm">
            <section class="content">
                ...
                <input type="hidden" id="marque_vehicule" name="marque_vehicule" value="<?php echo $ligne['make_name'] ?>" class="form-control">
                <input type="hidden" id="modele_vehicule" name="modele_vehicule" value="<?php echo $ligne['model_name'] ?>" class="form-control">
