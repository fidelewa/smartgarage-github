                                ...
                                <div class="row">
                                    <table class="table dt-responsive">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-right">Montant total (avec la main d'oeuvre):</td>
                                                <td><?php echo $row['somme_total_prix_piece_rechange_devis']; ?></td>
                                            </tr>
                                            <tr>
